...
exports.DbServer = function (options) {
    ...
    var db = {
        ...
        connect: function (host) {
            ...
            if(options.models){
                for(var m in options.models){
                    self.models[m] = self.model(m, options.models[m]);
                }
            }
        ...
        create: function (table, data) {
            ...
            var model = new this.models[table](data);
        ...
        update: function (table, id, data) {
            this.models[table].findByIdAndUpdate(id, data, function (model) {
                if (model) {
                    return model;
                } else {
                    return false;
        ...
        destroy: function (table, id) {
            this.models[table].findByIdAndRemove(id, function (model) {
                if (model) {
                    return model;
                } else {
                    return false;
